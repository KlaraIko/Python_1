...
def is_win(player, opponent):
    # return ture if the player beats the opponent
...
def play_best_of(n):
    ...
    if player_wins > computer_wins:
        print ('You have wont the best of {} games! Great job!'.format(n))
    else:
        print('Unfortunatley the computer has won the best of {} games.'.format(n))
